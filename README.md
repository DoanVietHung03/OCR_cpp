...
Vehicle Detection: YOLO11s (yolo11s.onnx) - Phát hiện ô tô, xe máy, xe buýt, xe tải.

Plate Detection: YOLOv9 (yolov9_detect_plate.onnx) - Xác định vị trí biển số trên vùng ảnh của xe.

OCR (Optical Character Recognition): PARSeq (parseq_2.onnx) - Đọc ký tự trên biển số.
...
Biên dịch với CMake (thông qua Visual Studio):
